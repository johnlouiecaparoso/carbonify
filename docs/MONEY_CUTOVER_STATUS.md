...
>
> ✅ **Both applied 2026-08-05**, along with the other three `20260804*` migrations. Both keep their
> signature, so the checklist below is unaffected — but **step 3 (wallet purchase) now has a second
> expected outcome to check**: an unverified or suspended buyer must be *refused*, not merely capped
> by the velocity limit.
